...
This handout only mentions a small subset of the rich possibilities provided by the x86-64 instruction set and architecture. For a more complete (but still readable) introduction, consult The [_AMD64 Architecture Programmer's Manual, Volume 1: Application Programming_](http://support.amd.com/us/Pages/AMDSupportHub.aspx).
