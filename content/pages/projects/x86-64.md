...
This handout only mentions a small subset of the rich possibilities provided by the x86-64 instruction set and architecture. For a more complete (but still readable) introduction, consult The {{% resource_link "5ff0c070-77f1-4d3b-b413-2391b1f8e266" "*AMD64 Architecture Programmer's Manual, Volume 1: Application Programming*" %}}.
